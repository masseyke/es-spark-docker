...
RUN wget -q https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-$ELASTICSEARCH_VERSION-linux-aarch64.tar.gz && tar zxvf elasticsearch-$ELASTICSEARCH_VERSION-linux-aarch64.tar.gz && rm elasticsearch-$ELASTICSEARCH_VERSION-linux-aarch64.tar.gz
RUN wget -q https://artifacts.elastic.co/downloads/kibana/kibana-$ELASTICSEARCH_VERSION-linux-aarch64.tar.gz && tar zxvf kibana-$ELASTICSEARCH_VERSION-linux-aarch64.tar.gz && rm kibana-$ELASTICSEARCH_VERSION-linux-aarch64.tar.gz
